...
struct Button {
    ...
    Button(float x, float y, float width, float height, const std::string& txt, Color col);
    bool isClicked();
    void draw();
};
...
struct InputField {
    ...
    InputField(float x, float y, float width, float height, const std::string& lbl, int maxLen = 50);
    void update();
    void draw();
...
struct Dropdown {
    ...
    Dropdown(float x, float y, float width, float height, const std::string& lbl, const std::vector<std::string>& opts);
    void update();
    void draw();
