...
void ScheduleUI::initialize() {
    ...
    tabButtons.push_back(Button(tabWidth * 2, 0, tabWidth, 40, "Schedule", COLOR_PRIMARY));
    tabButtons.push_back(Button(tabWidth * 3, 0, tabWidth, 40, "Preferences", COLOR_PRIMARY));
